...
env.Append(
    ...
    CPPPATH=[
        ...
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "esp_hw_support", "debug_probe", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "esp_hw_support", "mspi_timing_tuning", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "esp_hw_support", "mspi_timing_tuning", "tuning_scheme_impl", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "esp_hw_support", "power_supply", "include"),
        ...
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "heap", "tlsf"),
        ...
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "soc", "esp32", "register"),
        ...
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "esp_rom", "esp32", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "esp_rom", "esp32", "include", "esp32"),
        ...
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "esp_driver_twai", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "espressif__esp_jpeg", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "espressif__esp_matter", "connectedhomeip", "connectedhomeip", "src"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "espressif__esp_matter", "connectedhomeip", "connectedhomeip", "src", "app", "ember_coupling"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "espressif__esp_matter", "connectedhomeip", "connectedhomeip", "src", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "espressif__esp_matter", "connectedhomeip", "connectedhomeip", "src", "lib"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "espressif__esp_matter", "connectedhomeip", "connectedhomeip", "src", "lib", "dnssd"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "espressif__esp_matter", "connectedhomeip", "connectedhomeip", "src", "platform", "OpenThread"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "espressif__esp_matter", "connectedhomeip", "connectedhomeip", "third_party", "jsoncpp", "repo", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "espressif__esp_matter", "connectedhomeip", "connectedhomeip", "third_party", "nlfaultinjection", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "espressif__esp_matter", "connectedhomeip", "connectedhomeip", "third_party", "nlassert", "repo", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "espressif__esp_matter", "connectedhomeip", "connectedhomeip", "third_party", "nlio", "repo", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "espressif__esp_matter", "connectedhomeip", "connectedhomeip", "zzz_generated", "app-common"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "esp-idf", "espressif__esp_matter"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "esp_matter", "zap_common"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "esp_matter"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "esp_matter", "utils"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "esp_matter_bridge"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "esp_matter_console"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "espressif__esp_matter", "connectedhomeip", "connectedhomeip", "src", "platform", "ESP32"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "espressif__esp_matter", "connectedhomeip", "connectedhomeip", "src", "platform", "ESP32", "bluedroid"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "espressif__esp_matter", "connectedhomeip", "connectedhomeip", "src", "platform", "ESP32", "nimble"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "espressif__esp_matter", "connectedhomeip", "connectedhomeip", "src", "platform", "ESP32", "route_hook"),
        ...
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "bt", "common", "ble_log", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "bt", "host", "bluedroid", "api", "include", "api"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "bt", "esp_ble_mesh", "common", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "bt", "esp_ble_mesh", "core"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "bt", "esp_ble_mesh", "core", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "bt", "esp_ble_mesh", "core", "storage"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "bt", "esp_ble_mesh", "btc", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "bt", "esp_ble_mesh", "models", "common", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "bt", "esp_ble_mesh", "models", "client", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "bt", "esp_ble_mesh", "models", "server", "include"),
        ...
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "bt", "esp_ble_mesh", "lib", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "bt", "esp_ble_mesh", "v1.1", "api", "core", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "bt", "esp_ble_mesh", "v1.1", "api", "models", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "bt", "esp_ble_mesh", "v1.1", "btc", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "bt", "esp_ble_mesh", "v1.1", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "bt", "esp_ble_mesh", "v1.1", "dfu"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "bt", "esp_ble_mesh", "v1.1", "mbt"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "bt", "common", "tinycrypt", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "bt", "common", "tinycrypt", "port"),
        ...
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "openthread", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "openthread", "openthread", "include"),
        ...
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "espressif__esp_delta_ota", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "espressif__esp_encrypted_img", "include"),
        ...
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "esp_security", "include"),
        ...
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "esp_driver_bitscrambler", "include"),
        ...
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "esp_driver_touch_sens", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "esp_driver_touch_sens", "hw_ver1", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "esp_hal_ieee802154", "include"),
        ...
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "rt", "include"),
        ...
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "espressif__cbor", "tinycbor", "src"),
        ...
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "espressif__esp-zigbee-lib", "include", "radio_spinel"),
        ...
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "espressif__esp_modem", "command", "include"),
        ...
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "espressif__lan86xx_common", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "espressif__lan867x", "include"),
    ...
    LIBS=[
        "-lxtensa", "-lesp_driver_gpio", "-lesp_pm", "-lmbedtls", "-lesp_app_format", "-lesp_bootloader_format", "-lapp_update", "-lesp_partition", "-lefuse", "-lbootloader_support", "-lesp_mm", "-lspi_flash", "-lesp_system", "-lesp_common", "-lesp_rom", "-lhal", "-llog", "-lheap", "-lsoc", "-lesp_security", "-lesp_hw_support", "-lfreertos", "-lnewlib", "-lpthread", "-lcxx", "-lesp_timer", "-lesp_driver_gptimer", "-lesp_ringbuf", "-lesp_driver_spi", "-lesp_psram", "-lesp_driver_uart", "-lapp_trace", "-lesp_event", "-lnvs_flash", "-lesp_phy", "-lesp_vfs_console", "-lvfs", "-llwip", "-lesp_netif", "-lwpa_supplicant", "-lesp_coex", "-lesp_wifi", "-lesp_gdbstub", "-lbt", "-lunity", "-lcmock", "-lconsole", "-lesp_driver_pcnt", "-lesp_driver_mcpwm", "-lesp_driver_i2s", "-lsdmmc", "-lesp_driver_sdmmc", "-lesp_driver_sdspi", "-lesp_driver_sdio", "-lesp_driver_dac", "-lesp_driver_rmt", "-lesp_driver_sdm_2", "-lesp_driver_i2c", "-lesp_driver_ledc", "-lesp_driver_twai", "-ldriver", "-lhttp_parser", "-lesp-tls", "-lesp_adc", "-lesp_driver_cam", "-lesp_driver_touch_sens", "-lesp_eth", "-lesp_hid", "-ltcp_transport", "-lesp_http_client", "-lesp_http_server", "-lesp_https_ota", "-lesp_https_server", "-lesp_lcd", "-lprotobuf-c", "-lprotocomm", "-lesp_local_ctrl", "-lespcoredump", "-lwear_levelling", "-lfatfs", "-ljson", "-lmqtt", "-lnvs_sec_provider", "-lopenthread", "-lperfmon", "-lrt", "-lspiffs", "-lulp", "-lwifi_provisioning", "-lespressif__esp-nn", "-lespressif__esp-tflite-micro", "-lespressif__esp_jpeg", "-lespressif__esp32-camera", "-lespressif__esp_secure_cert_mgr", "-lespressif__json_parser", "-lespressif__json_generator", "-lespressif__mdns", "-lespressif__esp_delta_ota", "-lespressif__esp_encrypted_img", "-lespressif__rmaker_common", "-lespressif__esp_diagnostics", "-lespressif__cbor", "-lespressif__esp_diag_data_store", "-lespressif__esp_insights", "-lespressif__esp-serial-flasher", "-lespressif__esp_rcp_update", "-lespressif__esp_matter", "-lchmorgan__esp-libhelix-mp3", "-lespressif__esp-modbus", "-lespressif__esp-zigbee-lib", "-lespressif__libsodium", "-lespressif__esp-dsp", "-lespressif__esp_modem", "-lespressif__esp_schedule", "-lespressif__network_provisioning", "-lespressif__esp_rainmaker", "-lespressif__lan86xx_common", "-lespressif__lan867x", "-lespressif__qrcode", "-ljoltwallet__littlefs", "-lfb_gfx", "-lapp_trace", "-lapp_trace", "-lcmock", "-lunity", "-lesp_driver_cam", "-lesp_lcd", "-lnvs_sec_provider", "-lperfmon", "-lrt", "-lespressif__esp-tflite-micro", "-lespressif__esp-nn", "-lm", "-lespressif__esp32-camera", "-lespressif__esp_jpeg", "-lesp_driver_touch_sens", "-lesp_hid", "-lespressif__esp_matter", "-lfatfs", "-lwear_levelling", "-lspiffs", "-lespressif__esp_delta_ota", "-lespressif__esp_encrypted_img", "-lespressif__esp_insights", "-lespressif__esp_diagnostics", "-lespressif__cbor", "-lespressif__esp_diag_data_store", "-lchmorgan__esp-libhelix-mp3", "-lespressif__esp-modbus", "-lespressif__esp-zigbee-lib", "-lespressif__esp-zigbee-lib", "-lopenthread", "-lespressif__libsodium", "-lespressif__esp-dsp", "-lespressif__esp_modem", "-lespressif__esp_rainmaker", "-lesp_local_ctrl", "-lesp_https_server", "-lwifi_provisioning", "-lespressif__esp_secure_cert_mgr", "-lespressif__json_parser", "-lespressif__json_generator", "-lespressif__mdns", "-lespressif__esp_rcp_update", "-lespressif__esp-serial-flasher", "-lespressif__esp_schedule", "-lespressif__rmaker_common", "-lmqtt", "-lespressif__network_provisioning", "-lprotocomm", "-lbt", "-lble_mesh", "-lprotobuf-c", "-ljson", "-lopenthread", "-lconsole", "-lespressif__lan867x", "-lespressif__lan86xx_common", "-lesp_eth", "-lespressif__qrcode", "-ljoltwallet__littlefs", "-lxtensa", "-lesp_driver_gpio", "-lesp_pm", "-lmbedtls", "-lesp_app_format", "-lesp_bootloader_format", "-lapp_update", "-lesp_partition", "-lefuse", "-lbootloader_support", "-lesp_mm", "-lspi_flash", "-lesp_system", "-lesp_common", "-lesp_rom", "-lhal", "-llog", "-lheap", "-lsoc", "-lesp_security", "-lesp_hw_support", "-lfreertos", "-lnewlib", "-lpthread", "-lcxx", "-lesp_timer", "-lesp_driver_gptimer", "-lesp_ringbuf", "-lesp_driver_spi", "-lesp_psram", "-lesp_driver_uart", "-lesp_event", "-lnvs_flash", "-lesp_phy", "-lesp_vfs_console", "-lvfs", "-llwip", "-lesp_netif", "-lwpa_supplicant", "-lesp_coex", "-lesp_wifi", "-lesp_gdbstub", "-lesp_driver_pcnt", "-lesp_driver_mcpwm", "-lesp_driver_i2s", "-lsdmmc", "-lesp_driver_sdmmc", "-lesp_driver_sdspi", "-lesp_driver_sdio", "-lesp_driver_dac", "-lesp_driver_rmt", "-lesp_driver_sdm_2", "-lesp_driver_i2c", "-lesp_driver_ledc", "-lesp_driver_twai", "-ldriver", "-lhttp_parser", "-lesp-tls", "-lesp_adc", "-ltcp_transport", "-lesp_http_client", "-lesp_http_server", "-lesp_https_ota", "-lespcoredump", "-lulp", "-lmbedtls_2", "-lmbedcrypto", "-lmbedx509", "-leverest", "-lp256m", "-lcoexist", "-lcore", "-lespnow", "-lmesh", "-lnet80211", "-lpp", "-lsmartconfig", "-lwapi", "-lxtensa", "-lesp_driver_gpio", "-lesp_pm", "-lmbedtls", "-lesp_app_format", "-lesp_bootloader_format", "-lapp_update", "-lesp_partition", "-lefuse", "-lbootloader_support", "-lesp_mm", "-lspi_flash", "-lesp_system", "-lesp_common", "-lesp_rom", "-lhal", "-llog", "-lheap", "-lsoc", "-lesp_security", "-lesp_hw_support", "-lfreertos", "-lnewlib", "-lpthread", "-lcxx", "-lesp_timer", "-lesp_driver_gptimer", "-lesp_ringbuf", "-lesp_driver_spi", "-lesp_psram", "-lesp_driver_uart", "-lesp_event", "-lnvs_flash", "-lesp_phy", "-lesp_vfs_console", "-lvfs", "-llwip", "-lesp_netif", "-lwpa_supplicant", "-lesp_coex", "-lesp_wifi", "-lesp_gdbstub", "-lesp_driver_pcnt", "-lesp_driver_mcpwm", "-lesp_driver_i2s", "-lsdmmc", "-lesp_driver_sdmmc", "-lesp_driver_sdspi", "-lesp_driver_sdio", "-lesp_driver_dac", "-lesp_driver_rmt", "-lesp_driver_sdm_2", "-lesp_driver_i2c", "-lesp_driver_ledc", "-lesp_driver_twai", "-ldriver", "-lhttp_parser", "-lesp-tls", "-lesp_adc", "-ltcp_transport", "-lesp_http_client", "-lesp_http_server", "-lesp_https_ota", "-lespcoredump", "-lulp", "-lmbedtls_2", "-lmbedcrypto", "-lmbedx509", "-leverest", "-lp256m", "-lcoexist", "-lcore", "-lespnow", "-lmesh", "-lnet80211", "-lpp", "-lsmartconfig", "-lwapi", "-lxtensa", "-lesp_driver_gpio", "-lesp_pm", "-lmbedtls", "-lesp_app_format", "-lesp_bootloader_format", "-lapp_update", "-lesp_partition", "-lefuse", "-lbootloader_support", "-lesp_mm", "-lspi_flash", "-lesp_system", "-lesp_common", "-lesp_rom", "-lhal", "-llog", "-lheap", "-lsoc", "-lesp_security", "-lesp_hw_support", "-lfreertos", "-lnewlib", "-lpthread", "-lcxx", "-lesp_timer", "-lesp_driver_gptimer", "-lesp_ringbuf", "-lesp_driver_spi", "-lesp_psram", "-lesp_driver_uart", "-lesp_event", "-lnvs_flash", "-lesp_phy", "-lesp_vfs_console", "-lvfs", "-llwip", "-lesp_netif", "-lwpa_supplicant", "-lesp_coex", "-lesp_wifi", "-lesp_gdbstub", "-lesp_driver_pcnt", "-lesp_driver_mcpwm", "-lesp_driver_i2s", "-lsdmmc", "-lesp_driver_sdmmc", "-lesp_driver_sdspi", "-lesp_driver_sdio", "-lesp_driver_dac", "-lesp_driver_rmt", "-lesp_driver_sdm_2", "-lesp_driver_i2c", "-lesp_driver_ledc", "-lesp_driver_twai", "-ldriver", "-lhttp_parser", "-lesp-tls", "-lesp_adc", "-ltcp_transport", "-lesp_http_client", "-lesp_http_server", "-lesp_https_ota", "-lespcoredump", "-lulp", "-lmbedtls_2", "-lmbedcrypto", "-lmbedx509", "-leverest", "-lp256m", "-lcoexist", "-lcore", "-lespnow", "-lmesh", "-lnet80211", "-lpp", "-lsmartconfig", "-lwapi", "-lxtensa", "-lesp_driver_gpio", "-lesp_pm", "-lmbedtls", "-lesp_app_format", "-lesp_bootloader_format", "-lapp_update", "-lesp_partition", "-lefuse", "-lbootloader_support", "-lesp_mm", "-lspi_flash", "-lesp_system", "-lesp_common", "-lesp_rom", "-lhal", "-llog", "-lheap", "-lsoc", "-lesp_security", "-lesp_hw_support", "-lfreertos", "-lnewlib", "-lpthread", "-lcxx", "-lesp_timer", "-lesp_driver_gptimer", "-lesp_ringbuf", "-lesp_driver_spi", "-lesp_psram", "-lesp_driver_uart", "-lesp_event", "-lnvs_flash", "-lesp_phy", "-lesp_vfs_console", "-lvfs", "-llwip", "-lesp_netif", "-lwpa_supplicant", "-lesp_coex", "-lesp_wifi", "-lesp_gdbstub", "-lesp_driver_pcnt", "-lesp_driver_mcpwm", "-lesp_driver_i2s", "-lsdmmc", "-lesp_driver_sdmmc", "-lesp_driver_sdspi", "-lesp_driver_sdio", "-lesp_driver_dac", "-lesp_driver_rmt", "-lesp_driver_sdm_2", "-lesp_driver_i2c", "-lesp_driver_ledc", "-lesp_driver_twai", "-ldriver", "-lhttp_parser", "-lesp-tls", "-lesp_adc", "-ltcp_transport", "-lesp_http_client", "-lesp_http_server", "-lesp_https_ota", "-lespcoredump", "-lulp", "-lmbedtls_2", "-lmbedcrypto", "-lmbedx509", "-leverest", "-lp256m", "-lcoexist", "-lcore", "-lespnow", "-lmesh", "-lnet80211", "-lpp", "-lsmartconfig", "-lwapi", "-lxtensa", "-lesp_driver_gpio", "-lesp_pm", "-lmbedtls", "-lesp_app_format", "-lesp_bootloader_format", "-lapp_update", "-lesp_partition", "-lefuse", "-lbootloader_support", "-lesp_mm", "-lspi_flash", "-lesp_system", "-lesp_common", "-lesp_rom", "-lhal", "-llog", "-lheap", "-lsoc", "-lesp_security", "-lesp_hw_support", "-lfreertos", "-lnewlib", "-lpthread", "-lcxx", "-lesp_timer", "-lesp_driver_gptimer", "-lesp_ringbuf", "-lesp_driver_spi", "-lesp_psram", "-lesp_driver_uart", "-lesp_event", "-lnvs_flash", "-lesp_phy", "-lesp_vfs_console", "-lvfs", "-llwip", "-lesp_netif", "-lwpa_supplicant", "-lesp_coex", "-lesp_wifi", "-lesp_gdbstub", "-lesp_driver_pcnt", "-lesp_driver_mcpwm", "-lesp_driver_i2s", "-lsdmmc", "-lesp_driver_sdmmc", "-lesp_driver_sdspi", "-lesp_driver_sdio", "-lesp_driver_dac", "-lesp_driver_rmt", "-lesp_driver_sdm_2", "-lesp_driver_i2c", "-lesp_driver_ledc", "-lesp_driver_twai", "-ldriver", "-lhttp_parser", "-lesp-tls", "-lesp_adc", "-ltcp_transport", "-lesp_http_client", "-lesp_http_server", "-lesp_https_ota", "-lespcoredump", "-lulp", "-lmbedtls_2", "-lmbedcrypto", "-lmbedx509", "-leverest", "-lp256m", "-lcoexist", "-lcore", "-lespnow", "-lmesh", "-lnet80211", "-lpp", "-lsmartconfig", "-lwapi", "-lxt_hal", "-lc", "-lm", "-lstdc++", "-lpthread", "-lnewlib", "-lgcc", "-lcxx", "-lphy", "-lrtc", "-lesp_phy", "-lphy", "-lrtc", "-lesp_phy", "-lphy", "-lrtc", "-lbtdm_app"
    ],
    ...
    CPPDEFINES=[
        ...
        "ESP_PLATFORM",
        ("IDF_VER", '\\"v5.5.2-729-g87912cd291\\"'),
